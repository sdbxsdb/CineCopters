...
<section id="cinecoptersHome">
  ...
  <div class="container" id=firstInfo>
    ...
    <div class="info">
      <p>For as long as drones have been around, CineCopters, based in Belfast, Northern Ireland have been ahead of the pack.<br><br>
        ...
        We know how this works. We make your life easy.</p>
    </div>
  ...
  <div class="container" id="lastInfo">
    ...
    <div class="container card-group">
      ...
      <div class="card">
        <a href="https://www.buccaneermedia.com/" target="blank">
          <div class="card-body">
            <h5 class="card-title">Breathtaking</h5>
            <p class="card-text">“A calm and professional approach, incredibly competitive rates and the ability to deliver utterly breathtaking shots. Exec Producers from Canada, New York and beyond were amazed. Highly recommended”</p>
            <hr>
            <h5 class="card-text">Stacey James - <small>Producer</small></h5>
            <h6 class="card-text job">Ride - Feature Film</h6>
          </div>
        </a>
      </div>
      <div class="card">
    ...
    <div class=" container card-group">
      <div class="card">
        <a href="https://www.pullthetrigger.ie/" target="blank">
          <div class="card-body">
            <h5 class="card-title">Exemplary</h5>
            <p class="card-text">“Their work was exemplary as always and the Directors and clients were over the moon with the work they did - everyone was singing their praises. And as for getting me out of the bind - I so so appreciate it. I always say you guys are the best and your lads proved it again.”</p>
            <hr>
            <h5 class="card-text">Orla Bleahen - <small><cite>Producer</cite></small></h5>
            <h6 class="card-text">Sea Fever - Feature Film</h6>
          </div>
        </a>
      </div>
      <div class="card">
      ...
      <div class="card">
        <a href="https://hinterlandfilms.com/" target="blank">
          <div class="card-body">
            <h5 class="card-title">Outstanding</h5>
            <p class="card-text">“We have always found the Cinecopters crew a pleasure to deal with.
